...
<div class="field-set">
    <div class="row">
        <div class="col-lg-3 col-12">
            ...
            <input wire:model="personable.cpf" class="form-control form-control-sm" required @if($readonly) disabled @endif>
            @error('personable.cpf') <span class="error">{{ $message }}</span>@enderror
        </div>
        <div class="col-lg-6 col-12">
            <label class="control-label">Nome</label><sup>•</sup>
            <input wire:model="personable.name" class="form-control form-control-sm" required @if($readonly) disabled @endif>
            @error('personable.name') <span class="error">{{ $message }}</span>@enderror
        </div>
        <div class="col-lg-3 col-12">
            <label class="control-label">Apelido</label>
            <input wire:model="personable.alias" class="form-control form-control-sm" @if($readonly) disabled @endif>
    ...
    <div class="row">
        <div class="col-lg-3 col-12">
            ...
            <input wire:model="personable.rg" class="form-control form-control-sm" required @if($readonly) disabled @endif>

...
<div class="field-set">
    <div class="row">
        <div class="col-lg-3 col-12">
            ...
            <input wire:model="address.cep" class="form-control form-control-sm" required @if($readonly) disabled @endif>
            @error('person.address.cep') <span class="error">{{ $message }}</span>@enderror
        </div>
        <div class="col-lg-3 col-12">
            <label class="control-label">Logradouro</label><sup>•</sup>
            <input wire:model="person.address.address" class="form-control form-control-sm" required @if($readonly) disabled @endif>
            @error('address.address') <span class="error">{{ $message }}</span>@enderror
        </div>
        <div class="col-lg-3 col-12">
            <label class="control-label">Número</label><sup>•</sup>
            <input wire:model="person.address.building_number" class="form-control form-control-sm" required @if($readonly) disabled @endif>
            @error('person.address.building_number') <span class="error">{{ $message }}</span>@enderror
        </div>
        <div class="col-lg-3 col-12">
            <label class="control-label">Complemento</label>
            <input wire:model="person.address.complement" class="form-control form-control-sm" required @if($readonly) disabled @endif>
        ...
        <div class="row">
            <div class="col-lg-3 col-12">
                ...
                <input wire:model="person.address.area" class="form-control form-control-sm" required @if($readonly) disabled @endif>
                @error('person.address.area') <span class="error">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-3 col-12">
                <label class="control-label">Ponto de Referência</label>
                <input wire:model="person.address.reference_point" class="form-control form-control-sm" required @if($readonly) disabled @endif>
                @error('person.address.reference_point') <span class="error">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-3 col-12">
                <label class="control-label">UF</label><sup>•</sup>
                <input list="uf" wire:model="person.address.city.state_id" class="form-control form-control-sm" required @if($readonly) disabled @endif>
                <datalist id="uf">
            ...
            <div class="col-lg-3 col-12"><sup>•</sup>
                ...
                <input wire:model="person.address.city_id" class="form-control form-control-sm" required @if($readonly) disabled @endif>
        ...
        <div class="row">
            <div class="col-lg-3 col-12">
                ...
                <input wire:model="person.address.is_condo" class="form-control form-control-sm" required @if($readonly) disabled @endif>

        ...
        <div class="field-set">
            <div class="row">
                <div class="col-lg-3 col-12">
                    ...
                    <input wire:model="person.cnpj" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
                    @error('person.cnpj') <span class="error">{{ $message }}</span>@enderror
                </div>
                <div class="col-lg-6 col-12">
                    <label class="control-label">Razão Social</label><sup>•</sup>
                    <input wire:model="person.company_name" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
                    @error('person.company_name') <span class="error">{{ $message }}</span>@enderror
                </div>
                <div class="col-lg-3 col-12">
                    <label class="control-label">Nome Fantasia</label><sup>•</sup>
                    <input wire:model="person.trading_name" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    ...
                    <select wire:model="person.ie_category" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <input wire:model="person.ie" class="form-control form-control-sm" @if($this->person?->ie_category?->required()) {{ 'required' }} @else {{ 'disabled '}} @endif @if($this->disableInputs) disabled @endif>
                    @error('person.ie') <span class="error">{{ $message }}</span>@enderror
                </div>
                <div class="col-lg-3 col-12">
                    <label class="control-label">Inscrição Municipal</label>
                    <input wire:model="person.im" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
                    @error('person.im') <span class="error">{{ $message }}</span>@enderror
                </div>
                <div class="col-lg-3 col-12">
                    <label class="control-label">Situação CNPJ</label>
                    <input wire:model="person.cnpj_status" class="form-control form-control-sm" id="cnpj" required @if($this->disableInputs) disabled @endif>
            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    ...
                    <select wire:model="person.tax_type" class="form-control form-control-sm" required @if($this->disableInputs) disabled @endif>
                        <option hidden>Selecione</option>

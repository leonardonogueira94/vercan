    ...
    <div class="col-12">
        <div class="row email-row">
            <div class="col-6">
                ...
                <input wire:model="phones.{{ $phone['contact']['index'] }}.phone" class="form-control form-control-sm"
            ...
            <div class="col-6">
                ...
                <select class="form-control form-control-sm" @if($phone == reset($this->phones)) required @endif>
                    ...
                    @foreach(App\Enums\Contact\ContactChannel::TELEFONE->tipos() as $case)
                        <option wire:model="phones.{{ $phone['contact']['index'] }}.type" value="{{ $case->value }}" 
